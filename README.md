...
The project includes production-ready Terraform configuration for deploying to AWS ECS Fargate.
...
After deploying the infrastructure, push your image to ECR:
...
| `cache_replicas` | `3` | Number of cache service replicas |
| `cache_cpu` | `512` | CPU units (512 = 0.5 vCPU) |
| `cache_memory` | `1024` | Memory in MB |
